package com.jiuan.framework.aspectj;
...
/**
 * @className: LogAspect
 * @description: the aspect for log operate log 日志方面为操作日志
 * @author: Dimple
 * @date: 10/22/19
 */
@Aspect
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.jiuan.framework.aspectj.lang.annotation.Log)")
    ...
    /**
     * set the log <code>com.jiuan.framework.aspectj.lang.annotation.Log</code> other descriptin
     *
     * @param joinPoint  join point
    ...
    /**
     * get annotation of <code>com.jiuan.framework.aspectj.lang.annotation.Log</code>
     *
     * @param joinPoint join point
     * @return the annotation of <code>com.jiuan.framework.aspectj.lang.annotation.Log</code>,if can not find will return <code>null</code>
     */
