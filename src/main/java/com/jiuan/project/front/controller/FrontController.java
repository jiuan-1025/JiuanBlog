package com.jiuan.project.front.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.jiuan.common.utils.StringUtils;
import com.jiuan.common.utils.http.HttpUtils;
import com.jiuan.framework.aspectj.lang.annotation.VLog;
...
import com.jiuan.project.front.domain.FrontMenu;
...
//        menuList.add(new FrontMenu("关于", 4, false, "/about"));
    ...
    @GetMapping("noticeclear")
    public AjaxResult clearNotice() {
        return AjaxResult.success(frontService.clearNotice());
    }
